    ...
    const renderAdded = (candidate) => {
      return (
        ...
        <div className="winner-votes">
          ...
          {/*<Grid container className="root" spacing={6}>
      <Grid item xs={12}>
        <Grid container justify="center" >
        <Card style={{paddingLeft:"100px"}}>
              <CardImg top width="200px" height="200px"img src={`https://ipfs.io/ipfs/${candidate.image}`}  alt="Card image cap" />
              <CardBody>
                <CardTitle tag="h4">{candidate.header}</CardTitle>
                <CardSubtitle tag="h5" className="mb-2 text-muted">{candidate.slogan}</CardSubtitle>
                <CardText>{candidate.id}</CardText>
         ...
         {/*} <Card style={{paddingLeft:"100px"}}>
              <CardImg top width="200px" height="200px" float="right" img src={`https://ipfs.io/ipfs/${candidate.image}`}  alt="Card image cap" />
              <CardBody float="right">
                <CardTitle tag="h4">{candidate.header}</CardTitle>
                <CardSubtitle tag="h5" className="mb-2 text-muted">{candidate.slogan}</CardSubtitle>
                <CardText>{candidate.id}</CardText>
                ...
                {/*<tr>
                  <td style={{paddingLeft:"150px"}}>{candidate.id}</td>
                  <td style={{paddingLeft:"150px"}}><img src={`https://ipfs.io/ipfs/${candidate.image}`} alt=""/></td>
                  <td style={{paddingLeft:"130px"}}>{candidate.header}</td>
                  <td style={{paddingLeft:"130px"}}>{candidate.slogan}</td>
                </tr>*/}
