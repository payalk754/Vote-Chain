...
{/*const Registration = () => {
    ...
    const [register, setRegister] = useState({name: "", voter_id: "",aadhar_no: "",account_no: ""});
    ...
    return (
      ...
      <body className='register-body'>
            <div className= 'register-container'>
              ...
              <form  onSubmit={addDoc} class='register-form' >
                  <h1 className='register-h1'>Register</h1>
                  <span className='register-span'> Create your account </span>
                  <input  type= "text" name='name' value={register.name} onChange={handleChange} placeholder="Name" />
                  <input  type= "text" name='voter_id' value={register.voter_id} onChange={handleChange} placeholder="voter id" />
                  <input  type= "text" name='aadhar_no' value={register.aadhar_no} onChange={handleChange} placeholder="Aadhar no" />
                  <input  type= "text" name='account_no' value={register.account_no} onChange={handleChange} placeholder="Account no" />
